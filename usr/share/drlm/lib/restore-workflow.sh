# restore-workflow.sh
#
# restore workflow for Disaster Recovery Linux Manager
#
...
WORKFLOW_restore_DESCRIPTION="run restore operation on a client."
WORKFLOWS=( ${WORKFLOWS[@]} restore )
